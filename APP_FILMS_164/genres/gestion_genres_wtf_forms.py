...
class FormWTFAjouterGenres(FlaskForm):
    ...
    nom_genre_wtf = StringField("Clavioter le prenom ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFUpdateGenre(FlaskForm):
    ...
    date_genre_wtf_essai = DateField("Clavioter la date de naissance", validators=[InputRequired("Date obligatoire"),
