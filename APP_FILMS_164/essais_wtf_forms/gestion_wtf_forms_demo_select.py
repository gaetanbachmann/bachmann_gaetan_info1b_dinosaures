    ...
    try:
        ...
        if request.method == "GET":
            ...
            for i in data_genres:
                genre_val_list_dropdown.append(i['prenom_personne'])
            ...
            form_demo.genres_dropdown_wtf.data = "OM"
            genre_selectionne = form_demo.genres_dropdown_wtf.data
            print("personne choisie dans la liste :", genre_selectionne)
...
def demo_select_dropdown_bootstrap():
    print("personne choisie dans la liste :")
