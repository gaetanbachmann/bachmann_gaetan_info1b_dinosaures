...
class MonPremierWTForm(FlaskForm):
    ...
    nom_genre_wtf = StringField("Clavioter la personne ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class DemoFormSelectWTF(FlaskForm):
    genres_dropdown_wtf = SelectField('Personnes (liste déroulante)',
                                      validators=[DataRequired(message="Sélectionner une personne.")],
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplist_genre = SubmitField("Choix personne")
